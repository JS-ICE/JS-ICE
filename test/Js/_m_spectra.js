...
// Creates the frequency menu on the web applet.
	...
	var str = "<form autocomplete='nope'  id='freqGroup' name='modelsVib' style='display:none'>";
		...
		str += "<BR>\n" + "<table>";
			...
			str += "</td></tr></table>";
			str += "<table border=0 class='contents'> <tr>";
				str += "<td>vector color</td> <td><script>jmolColorPickerBox([setColorWhat,'vectors'],[255,255,255],'vectorColorPicker')</script></td>";
				str += "</tr><tr><td>" + createButton("vibVectcolor", "Default color", 'onClickFreqParams()', 0) + "</td>";
			str += "</tr></table>";					
		str += "</td></tr>";
		str += "<tr><td colspan=2>";
